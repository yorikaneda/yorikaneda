                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" id="inputproductname" type="text" placeholder="Enter product name" name="nama_produk" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" id="inputproducttype" type="text" placeholder="Enter product type" name="tipe_produk" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputproductos">OS (Operating System)</label>
                                            <input class="form-control py-4" id="inputproductos" type="text" placeholder="Enter OS name" name="os_produk" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" id="inputproductprice" type="text" placeholder="Enter product price" name="harga_produk" required />
                                </div>
                                <div class="form-group">
                                    <label class="small mb-1" for="inputpurchaselink">Link Pembelian</label>
                                    <input class="form-control py-4" id="inputpurchaselink" type="text" placeholder="Enter purchase link" name="link_beli" required />
                                </div>
                                <div class="form-group">
                                    <label class="small mb-1" for="inputspeclink">Spesisfikasi Produk</label>
                                    <input class="form-control py-4" id="inputspeclink" type="text" placeholder="Enter Specification link" name="spek_produk" required />
                                </div>
