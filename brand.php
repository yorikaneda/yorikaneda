                        ...
                        <div class="card-header text-center align-text-middle">
                            <div class="row align-middle">
                                ...
                                <div class="col-sm-12 text-left">
                                    <a class="btn btn-primary" href="brand-tambah.php">Tambah Data
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered text-center align-text-middle" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($brand as $merek) : ?>
                                            <tr>
                                                <td class="align-middle"><?php echo $merek["nama_brand"]; ?></td>
                                                <td class="align-middle"><img class=" h-25" src="images/Brand/<?php echo $merek["gambar"]; ?>" alt="">
                                                </td>
                                                <td class="align-middle">
                                                    <a href="brand-ubah.php?id=<?php echo $merek["id"]; ?>"><img src="https://img.icons8.com/color/24/000000/edit-file.png" /></a> |
                                                    <a href="brand-hapus.php?id=<?php echo $merek["id"]; ?>" onclick="return confirm('Apakah Anda Yakin?');"><img src="https://img.icons8.com/color/24/000000/delete-forever.png" /></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
