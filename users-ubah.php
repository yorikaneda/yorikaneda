...
$id = $_GET["id"];
$users = rescer("SELECT * FROM users WHERE id = $id")[0];
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Enter Username" name="username" value="<?php echo $users["username"]; ?>" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" id="inputConfirmPassword" type="password" placeholder="Confirm password" name="password2" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="small mb-1" for="inputEmailAddress">Email</label>
                                    <input class="form-control py-4" id="inputEmailAddress" type="email" placeholder="Enter email address" name="email" value="<?php echo $users["email"]; ?>" required />
                                </div>
                                <div class=" form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-group mt-4 mb-0"><a href="users.php" class="btn btn-secondary btn-block">Kembali</a></div>
                                        </div>
                                    </div>
                                </div>
                            </form>
