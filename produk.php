        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header text-left align-text-bottom">
                            <div class="row align-middle">
                                <!-- tambah -->
                                <div class="col-sm-12 text-left">
                                    <a class="btn btn-primary" href="produk-tambah.php">Tambah Data
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered text-center sorting" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php foreach ($produk as $item) : ?>
                                            <tr>
                                                <td class="align-middle"><?php echo $item["nama_brand"]; ?></td>
                                                <td class="align-middle"><?php echo $item["nama_produk"]; ?></td>
                                                <td class="align-middle"><?php echo $item["tipe_produk"]; ?></td>
                                                <td class="align-middle"><?php echo $item["os_produk"]; ?></td>
                                                <?php $rupiah = $item["harga_produk"]; ?>
                                                <td class="align-middle" id="rupiah"><?php echo rupiah($rupiah); ?></td>
                                                <td class="align-middle"><img class=" h-25" src="images/Card/<?php echo $item["gambar"]; ?>"></td>
                                                <td class="align-middle">
                                                    <a href="produk-ubah.php?id=<?php echo $item["id"]; ?>"><img src="https://img.icons8.com/color/24/000000/edit-file.png" /></a>
                                                    <a href="produk-hapus.php?id=<?php echo $item["id"]; ?>" onclick="return confirm('Apakah Anda Yakin?');">
                                                        <img src="https://img.icons8.com/color/24/000000/delete-forever.png" /></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
