...
$id = $_GET["id"];
$brand = rescer("SELECT * FROM brand WHERE id = $id")[0];
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Ubah Brand</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="brand.php">Brand</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Ubah Brand</li>
                    </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="gambarLama" value="<?php echo $brand["gambar"]; ?>">

                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputbrandname">Nama Brand / Merek</label>
                                            <input class="form-control py-4" id="inputbrandname" type="text" placeholder="Enter brand name" name="nama_brand" value="<?php echo $brand["nama_brand"]; ?>" required />
                                        </div>
                                    </div>
                                </div>
                                <img src="images/Brand/<?php echo $brand["gambar"]; ?>" class="my-5" width="250">
